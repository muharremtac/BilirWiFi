...
if (uninstall_answer.lower() == "y"):
    ...
    os.system('rm -rf /etc/bilirwifi')
    os.system('rm -rf /usr/lib/bilirwifi')
    os.system('rm -rf /etc/cron.bilirwifi')
    ...
    os.system('sed -i \'s/@reboot root run-parts \/etc\/cron.bilirwifi\///\' /etc/crontab')
